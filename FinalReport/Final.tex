...
\begin{document}
	...
	\begin{multicols}{2}
		...
		Table \ref{table:nn_performance} includes the final loss values computed for each dataset, measured as MSE. Conclusions about the dataset can also be drawn from these results. Performance was observed to be far greater on the ART dataset than any other.
		\begin{center}
            \captionsetup{type=figure}
		...
		\begin{tabular}{l|c|c|c}
			...
			\hline
			ART & \(1.9\text{e-}3\) & \(1.1\text{e-}3\) & 
			\(1.2\text{e-}3\) \\
			Grand Rapids & \(3.8\text{e-}3\) & \(3.5\text{e-}3\) & \(3.6\text{e-}3\) \\
			Kings County & \(3.7\text{e-}3\) & \(4.5\text{e-}3\) & \(3.3\text{e-}3\) \\
			Nashville & \(9.6\text{e-}3\) & \(10.1\text{e-}3\) & \(9.9\text{e-}3\)
		\end{tabular}
	...
	\end{center}
		...
		\begin{center}
			...
			\begin{tabular}{r|c|c|c|c|c|c|c|c}
				...
				\hline
				\small{ART} & \small{1.8e-03} & \small{4.5e-03} & \small{1.7e-03} & \small{?} & \small{?} & \small{?} & \small{?} & \small{?}\\
				\hline
				\small{Grand Rapids} & \small{6.3e-03} & \small{5.1e-03} & \small{8.5e-03} & \small{8.1e-03} & \small{?} & \small{?} & \small{?} & \small{?}\\
				\hline
