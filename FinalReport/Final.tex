...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\begin{center}
			...
			\captionof{figure}{MSE of FFN on the Nashville dataset.}
		...
		\begin{center}
			...
			\captionof{figure}{MSE of FFN on the ART dataset.}
		...
		\begin{center}
			...
			\captionof{figure}{MSE of FFN on the King County dataset.}
		...
		\begin{center}
			...
			\captionof{figure}{MSE of FFN on the Grand Rapids dataset.}
