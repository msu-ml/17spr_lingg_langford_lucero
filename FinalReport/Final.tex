	...
	\begin{multicols}{2}
		...
		{\centering
			...
			\begin{tabular}{r|c}
				...
				\hline
				\small{No Preprocessing} & \small{8.6e+1} \\
				\hline
				\small{Value Normalizing} & \small{2.4e-3} \\
				\hline
		...
		{\centering
			...
			\begin{tabular}{r|c}
				...
				\hline
				\small{Mean} & \small{7.4e-3} \\
				\hline
				\small{Closest Value} & \small{5.3e-3} \\
				\hline
				\small{Closest Mean} & \small{4.4e-3} \\
				\hline
			\end{tabular}
