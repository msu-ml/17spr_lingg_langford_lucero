...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\captionsetup{type=figure}
			...
			\captionof{figure}{Comparison of performances for all regression classifers.}
		...
		\captionsetup{type=figure}
			...
			\captionof{figure}{Comparison of performances for all decision classifiers.}
			\label{fig:fig_class_best}
		\end{center}

		One trend that can be seen in most of the comparisons is that the Nashville data set, as epxected due to holes in the observations, fairly consistently performs the worst. The primary exception is in the case of a Single Classification Tree seen above, in which the Grand Rapids data set results in a worse model than the Nashville data set. 
